<div class="table-responsive">
	<table class="table table-striped table-hover">
		...
		$consulta = "SELECT * FROM pistas p, beat b, producer d
					WHERE p.cod_b = b.cod_b AND b.producer = d.cod_p AND nickname = '$productor'";
					...
					<tr>
						<td>
							<form method="post" action="include/publicar.php">
								<input type="hidden" name="codigo" value="'.$row['cod_b'].'"></input>
